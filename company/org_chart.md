...
**Founder**: kolad.oruku1@gmail.com — reviews `company/reports/`, owns the GitHub, Stripe, and Anthropic accounts this company runs on.
...
| Publisher | `.claude/agents/publisher.md` | Generates the cover, converts to EPUB/PDF, creates the Stripe listing, rebuilds the storefront, commits and pushes. |
